        ...
        <div class="row">
          <div class="footer-style-1-inner">
            <div class="widget-footer widget-text col-first col-small">
              <a href="#">
                <img class="logo-footer" src="{{ asset('images/logo.png') }}" alt="Logo Organic" />
              </a>
            ...
            <div class="copy-right-inner">
              ...
              <div class="widget widget-footer widget-footer-creadit-card">
                <ul class="list-unstyle">
                  <li>
                    <a href="#">
                      <img src="{{ asset('images/icons/creadit-card-01.png') }}" alt="creadit card" />
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img src="{{ asset('images/icons/creadit-card-02.png') }}" alt="creadit card" />
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img src="{{ asset('images/icons/creadit-card-03.png') }}" alt="creadit card" />
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img src="{{ asset('images/icons/creadit-card-04.png') }}" alt="creadit card" />
                    </a>
                  </li>
                </ul>
              </div>
